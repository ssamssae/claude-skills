...
- /goodnight step 4.5 자동 호출도 WSL 에서만 발화 (Mac 의 /goodnight 가 /insta-post 부르는 줄은 비활성)
- Mac 에서 호출하려면 강대종님이 "맥에서 인스타 올려" 라고 명시할 때만. 이 경우 호출 직후 WSL 에 SCP 로 posted.json 회수 (수동)
